import"./assets/header-691db440.js";import{t as p}from"./assets/vendor-7b59b48c.js";import"./assets/scroll-up-3fdede05.js";const x=localStorage.getItem("favorites"),c=JSON.parse(x)||[],L=document.querySelector(".favorites-text"),u=document.querySelector(".practice-list"),r=document.querySelector(".favorites-pagination"),d=document.querySelector(".exercise-header-dt"),v=document.querySelector(".exercise-header");c.length||L.classList.remove("visually-hidden");function h(e,i){const a=i<768?8:10;let t=[];if(e.length<=a)return e;for(let s=0;s<e.length;s+=a){let n=e.slice(s,s+a);t.push(n)}return t}const y=e=>e&&e.charAt(0).toUpperCase()+e.slice(1);function o(e){const i=e.map(({_id:a,name:t,rating:s,bodyPart:n,burnedCalories:l,target:f,time:g})=>`<li class="exercise-card">
