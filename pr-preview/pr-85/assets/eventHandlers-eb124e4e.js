import{i as v,t as Y}from"./vendor-347e8cf8.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))i(r);new MutationObserver(r=>{for(const n of r)if(n.type==="childList")for(const o of n.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&i(o)}).observe(document,{childList:!0,subtree:!0});function s(r){const n={};return r.integrity&&(n.integrity=r.integrity),r.referrerPolicy&&(n.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?n.credentials="include":r.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function i(r){if(r.ep)return;r.ep=!0;const n=s(r);fetch(r.href,n)}})();const g="https://your-energy.b.goit.study/api/",a={list:document.querySelector(".js-filtered-list"),filter:document.querySelector(".js-filters"),pagination:document.querySelector(".js-pagination"),exerciseHeaderSpan:document.querySelector(".js-exercise-header-span"),exerciseHeader:document.querySelector(".js-exercise-header"),searchForm:document.querySelector(".search-form"),searchInput:document.querySelector(".search-input"),searchInputCrossIcon:document.querySelector(".search-input-icon.cross-icon"),searchInputSearchIcon:document.querySelector(".search-input-icon.search-icon"),exercisePopUpBackdrop:document.querySelector(".exercise-pop-up-backdrop"),exercisePopUpContent:document.querySelector(".exercise-pop-up-content"),exercisePopUpCloseBtn:document.querySelector(".exercise-pop-up-close-btn"),exercisesContainer:document.querySelector(".exercises-container"),body:document.querySelector("body"),scrollUpButton:document.querySelector(".scroll-up-button"),mainSection:document.querySelector(".main-section"),ratingPopUpBackdrop:document.querySelector(".js-rating-pop-up-backdrop"),ratingPopUpContent:document.querySelector(".rating-pop-up-content"),ratingPopUpCloseBtn:document.querySelector(".js-close-rating-pop-up"),ratingForm:document.querySelector(".form-rating")},w={MUSCLES:"Muscles",BODY_PARTS:"Body parts",EQUIPMENT:"Equipment"},b=new URLSearchParams({filter:w.MUSCLES,page:1,limit:window.matchMedia("(min-width: 768px)").matches?12:9}),p=new URLSearchParams({page:1,limit:window.matchMedia("(min-width: 768px)").matches?10:8}),S={method:"GET",headers:{"Content-Type":"application/json"}};async function Z(){const e=await fetch(`${g}exercises?${p}`,S);if(!e.ok)throw new Error(`Ooops, status code: ${e.status}`);return await e.json()}async function ge(e,{rate:t,email:s,review:i}){const r={method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({rate:t,email:s,review:i})},n=await fetch(`${g}exercises/${e}/rating`,r),o=await n.json();if(!n.ok)throw new Error(o.message||"Failed to set a rating");return o}async function X(e){const t=await fetch(`${g}exercises/${e}`,S);if(!t.ok)throw new Error(`Ooops, status code: ${t.status}`);return await t.json()}async function ee(){const e=await fetch(`${g}filters?${b}`,S);if(!e.ok)throw new Error(`Ooops, status code: ${e.status}`);return await e.json()}async function he(){const e=await fetch(`${g}quote`,S);if(!e.ok)throw new Error(`Ooops, status code: ${e.status}`);return await e.json()}async function xe(e){const t={method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:e})},s=await fetch(`${g}subscription`,t),i=await s.json();if(!s.ok)throw new Error(i.message||"Failed to subscribe");return i}function O(e){return e.charAt(0).toUpperCase()+e.slice(1)}function te(e){const t=e.map(({filter:s,name:i,imgURL:r})=>`<li class="category-card fade-item" data-filter="${s}" data-name="${i}">
            ...
            <h3 class="category-card-text">${O(s)}</h3>
        ...
        </li>`).join("");a.list.classList.contains("exercise-list")&&a.list.classList.replace("exercise-list","filtered-list"),a.list.innerHTML=t}function P(e){return`<svg
              ...
              >
                <path
                  ...
                  fill="#242424"
                />
              </svg>`}function c({pageId:e,content:t,liClassNames:s}){const i=document.createElement("li"),r=document.createElement("a");return r.classList.add("pagination-link"),r.onclick=n=>{n.preventDefault()},r.href="#",r.innerHTML=t,i.classList.add(...s.filter(Boolean)),i.dataset.id=e,i.appendChild(r),i}function A(e,t){const s=document.createDocumentFragment(),i=Array(e).fill(0);if(e>9){const r=c({pageId:1,content:`${P("first")}${P("first")}`,liClassNames:["pagination-arrow","go-to-first",t===1?"disabled":""]});s.appendChild(r);const n=c({pageId:t-1<1?1:t-1,content:P(),liClassNames:["pagination-arrow","go-to-prev",t===1?"disabled":""]});s.appendChild(n);let o=t-1<1?1:t-1,m=t+1>e?e:t+1;if(m-o<2&&(o===1?m=o+2:o=m-2),o!==1){const y=c({pageId:-1,content:"...",liClassNames:["pagination-item","three-dots"]});s.appendChild(y)}if(i.slice(o-1,m).map((y,k)=>{const W=c({pageId:o+k,content:o+k,liClassNames:["pagination-item",t===o+k?"active":""]});s.appendChild(W)}),m!==e){const y=c({pageId:-1,content:"...",liClassNames:["pagination-item","three-dots"]});s.appendChild(y)}const $=c({pageId:t+1>e?e:t+1,content:q(),liClassNames:["pagination-arrow","go-to-next",t===e?"disabled":""]});s.appendChild($);const N=c({pageId:e,content:`${q("last")}${q("last")}`,liClassNames:["pagination-arrow","go-to-last",t===e?"disabled":""]});s.appendChild(N)}else i.map((r,n)=>{const o=c({pageId:n+1,content:n+1,liClassNames:["pagination-item",t===n+1?"active":""]});s.appendChild(o)});a.pagination.innerHTML="",a.pagination.appendChild(s)}const se=e=>e&&e.charAt(0).toUpperCase()+e.slice(1);function D(e,t=!1){return e.map(({_id:s,name:i,rating:r,bodyPart:n,burnedCalories:o,target:m,time:$})=>`<li class="exercise-card fade-item">
    ...
    </div>`;let r=e,n="";for(let o=0;o<5;o++)r>=1?n+=t:r>0?n+=i(r*100):n+=s,r--;return`
  ...
  `}function _(e){let t=x();const s=t.find(r=>r._id===e);if(!s)return!1;const i=t.filter(r=>r._id!==e);return localStorage.setItem("favorites",JSON.stringify(i)),v.success({message:`Exercise ${s.name} removed from favorites!`}),!0}function x(){const e=localStorage.getItem("favorites");return JSON.parse(e)||[]}let L=[];const I=document.querySelector(".favorites-text"),f=document.querySelector(".practice-list"),l=document.querySelector(".js-pagination");function le(e,t){let s=[];for(let i=0;i<e.length;i+=t)s.push(e.slice(i,i+t));return s}function de(e){const t=e.target.closest(".exercise-remove-btn");if(!t)return;const s=t.getAttribute("data-exercise-id");s&&_(s)&&h(x(),!0)}function F(e){f.innerHTML=D(e,!0),B()}function G(e,t){l.innerHTML="",l.classList.remove("visually-hidden"),e.forEach((s,i)=>{const r=c({pageId:i,content:i+1,liClassNames:["pagination-item",t===i?"active":""]});r.addEventListener("click",()=>{F(s),G(e,i),f.scrollIntoView({behavior:"smooth"})}),l.appendChild(r)}),e.length<=1&&l.classList.add("visually-hidden")}function h(e=L,t=!1){if(e.length)I.classList.add("visually-hidden"),f.classList.remove("hidden");else{I.classList.remove("visually-hidden"),f.innerHTML="",f.classList.add("hidden"),l.classList.add("hidden");return}const s=window.innerWidth;l.classList.add("hidden");let i=s<768?8:10;if(s>=1440&&(i=10),e.length<=i)F(e),l.classList.add("visually-hidden");else{const r=le(e,i);let n=0;if(t){const o=l.querySelector(".pagination-item.active");n=o?parseInt(o.getAttribute("data-id"),10):0,n>=r.length&&(n=r.length-1)}r.length===0?(I.classList.remove("visually-hidden"),l.classList.add("visually-hidden")):(F(r[n]),G(r,n))}}document.addEventListener("DOMContentLoaded",()=>{if(window.location.pathname.includes("favorites.html")){L=x(),h(L);const e=Y(()=>h(L),50);window.addEventListener("resize",e),f.addEventListener("click",fe),f.addEventListener("click",de)}});let d=null,u=null;function ue(e){pe(e).then(t=>{d=document.querySelector("#add-favorites"),a.exercisePopupAddFavoritesBtn=d,u=document.querySelector("#remove-favorites"),a.exercisePopupRemoveFavoritesBtn=u,d&&(d.dataset.exercise=JSON.stringify(t),d.addEventListener("click",V,{passive:!0})),u&&(u.dataset.exercise=JSON.stringify(t),u.addEventListener("click",K,{passive:!0})),a.exercisePopUpCloseBtn.addEventListener("click",E,{passive:!0}),a.exercisePopUpBackdrop.addEventListener("click",z,{passive:!0}),a.exercisePopUpBackdrop.classList.add("is-open"),a.body.classList.add("overflow-hidden"),document.addEventListener("keydown",Q)}).catch(t=>{v.error({message:`${t}`})})}function E(){a.exercisePopUpBackdrop.classList.remove("is-open"),a.body.classList.remove("overflow-hidden"),d&&d.removeEventListener("click",V),u&&u.removeEventListener("click",K),a.exercisePopUpBackdrop.removeEventListener("click",z),a.exercisePopUpCloseBtn.removeEventListener("click",E),document.removeEventListener("keydown",Q),d=null,u=null}function pe(e){return new Promise((t,s)=>{X(e).then(i=>{a.exercisePopUpContent.innerHTML=ce(i),t(i)}).catch(i=>{s(i)})})}function z(e){e.target===a.exercisePopUpBackdrop&&E()}function me(e){let t=x();t.some(s=>s._id===e._id)||(t.push(e),localStorage.setItem("favorites",JSON.stringify(t)),window.location.pathname.includes("favorites.html")&&h(t),v.success({message:"Exercise added to favorites!"}))}function V(e){const t=JSON.parse(d.dataset.exercise);me(t),e.stopPropagation(),console.log(a.exercisePopupAddFavoritesBtn),a.exercisePopupAddFavoritesBtn.classList.add("visually-hidden"),a.exercisePopupRemoveFavoritesBtn.classList.remove("visually-hidden")}function K(e){const t=JSON.parse(u.dataset.exercise);_(t._id)&&window.location.pathname.includes("favorites.html")&&h(x(),!0),a.exercisePopupAddFavoritesBtn.classList.remove("visually-hidden"),a.exercisePopupRemoveFavoritesBtn.classList.add("visually-hidden"),e.stopPropagation()}function Q(e){e.code==="Escape"&&E()}function ye(e){const t=e.target,s=t.closest("li.pagination-item:not(.active):not(.three-dots)")??t.closest("li.pagination-arrow:not(.disabled)");if(!s)return;const i=Number(s.dataset.id);b.set("page",i),p.set("page",i),a.exerciseHeaderSpan.dataset.exercise?T():J(),a.mainSection.scrollIntoView()}function Ce(e){const s=e.target.closest("li[data-filter]");if(!s)return;document.querySelectorAll(".js-filters .active").forEach(o=>o.classList.remove("active")),s.classList.add("active"),a.searchForm.reset(),a.searchForm.classList.add("hidden");const r=s.dataset.filter,n=Object.keys(w).find(o=>w[o]===r);n&&(b.set("filter",w[n]),b.set("page",1),p.delete("muscles"),p.delete("bodypart"),p.delete("equipment"),p.set("page",1),a.list.classList.replace("exercise-list","filtered-list"),J()),re()}function we(e){const s=e.target.closest("li.category-card");if(!s)return;let i=s.dataset.filter.toString().toLowerCase();i==="body parts"&&(i="bodypart");const r=s.dataset.name;ie(r),p.set(i,r),p.set("page",1),a.list.classList.replace("filtered-list","exercise-list"),a.searchForm.classList.remove("hidden"),a.list.innerHTML="",T(),a.mainSection.scrollIntoView()}function Le(e){e.preventDefault();const t=a.searchInput.value.trim();p.set("keyword",t),T()}function fe(e){const t=e.target.closest(".exercise-start-btn");if(!t)return;const s=t.getAttribute("data-exercise-id");s&&ue(s)}export{p as a,re as b,J as c,ye as d,we as e,fe as f,he as g,ge as h,T as i,Le as j,Ce as o,b as q,a as r,xe as s};
//# sourceMappingURL=eventHandlers-eb124e4e.js.map
