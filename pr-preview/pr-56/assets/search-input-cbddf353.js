import{r as a,c as U,d as P,e as q,q as y,a as c,F as C,f as A,g as O}from"./header-da5d0662.js";import{i as u}from"./vendor-7b59b48c.js";function L(e){return e.charAt(0).toUpperCase()+e.slice(1)}function H(e){const t=e.map(({filter:s,name:i,imgURL:r})=>`<li class="category-card fade-item" data-filter="${s}" data-name="${i}">
            <img
              src="${r}"
              alt="${i}"
            ...
            <p class="category-card-title">${L(i)}</p> 
            <h3 class="category-card-text">${L(s)}</h3>
            </div>
...
//# sourceMappingURL=search-input-cbddf353.js.map
