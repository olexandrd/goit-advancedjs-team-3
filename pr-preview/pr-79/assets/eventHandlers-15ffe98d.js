import{i as m,t as Y}from"./vendor-347e8cf8.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))r(i);new MutationObserver(i=>{for(const a of i)if(a.type==="childList")for(const n of a.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&r(n)}).observe(document,{childList:!0,subtree:!0});function s(i){const a={};return i.integrity&&(a.integrity=i.integrity),i.referrerPolicy&&(a.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?a.credentials="include":i.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function r(i){if(i.ep)return;i.ep=!0;const a=s(i);fetch(i.href,a)}})();const v="https://your-energy.b.goit.study/api/",o={list:document.querySelector(".js-filtered-list"),filter:document.querySelector(".js-filters"),pagination:document.querySelector(".js-pagination"),exerciseHeaderSpan:document.querySelector(".js-exercise-header-span"),exerciseHeader:document.querySelector(".js-exercise-header"),searchForm:document.querySelector(".search-form"),searchInput:document.querySelector(".search-input"),searchInputCrossIcon:document.querySelector(".search-input-icon.cross-icon"),searchInputSearchIcon:document.querySelector(".search-input-icon.search-icon"),exercisePopUpBackdrop:document.querySelector(".exercise-pop-up-backdrop"),exercisePopUpContent:document.querySelector(".exercise-pop-up-content"),exercisePopUpCloseBtn:document.querySelector(".exercise-pop-up-close-btn"),exercisesContainer:document.querySelector(".exercises-container"),body:document.querySelector("body"),scrollUpButton:document.querySelector(".scroll-up-button"),mainSection:document.querySelector(".main-section"),ratingPopUpBackdrop:document.querySelector(".js-rating-pop-up-backdrop"),ratingPopUpContent:document.querySelector(".rating-pop-up-content"),ratingPopUpCloseBtn:document.querySelector(".js-close-rating-pop-up"),ratingForm:document.querySelector(".form-rating")},C={MUSCLES:"Muscles",BODY_PARTS:"Body parts",EQUIPMENT:"Equipment"},b=new URLSearchParams({filter:C.MUSCLES,page:1,limit:window.matchMedia("(min-width: 768px)").matches?12:9}),l=new URLSearchParams({page:1,limit:window.matchMedia("(min-width: 768px)").matches?10:8}),S={method:"GET",headers:{"Content-Type":"application/json"}};async function Z(){const e=await fetch(`${v}exercises?${l}`,S);if(!e.ok)throw new Error(`Ooops, status code: ${e.status}`);return await e.json()}async function ge(e,{rate:t,email:s,review:r}){const i={method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({rate:t,email:s,review:r})},a=await fetch(`${v}exercises/${e}/rating`,i),n=await a.json();if(!a.ok)throw new Error(n.message||"Failed to set a rating");return n}async function X(e){const t=await fetch(`${v}exercises/${e}`,S);if(!t.ok)throw new Error(`Ooops, status code: ${t.status}`);return await t.json()}async function ee(){const e=await fetch(`${v}filters?${b}`,S);if(!e.ok)throw new Error(`Ooops, status code: ${e.status}`);return await e.json()}async function he(){const e=await fetch(`${v}quote`,S);if(!e.ok)throw new Error(`Ooops, status code: ${e.status}`);return await e.json()}async function xe(e){const t={method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:e})},s=await fetch(`${v}subscription`,t),r=await s.json();if(!s.ok)throw new Error(r.message||"Failed to subscribe");return r}function O(e){return e.charAt(0).toUpperCase()+e.slice(1)}function te(e){const t=e.map(({filter:s,name:r,imgURL:i})=>`<li class="category-card fade-item" data-filter="${s}" data-name="${r}">
        ...
        </li>`).join("");o.list.classList.contains("exercise-list")&&o.list.classList.replace("exercise-list","filtered-list"),o.list.innerHTML=t}function q(e){return`<svg
  ...
  `}function _(e){let t=h();const s=t.find(i=>i._id===e);if(!s)return!1;const r=t.filter(i=>i._id!==e);return localStorage.setItem("favorites",JSON.stringify(r)),m.success({message:`Exercise ${s.name} removed from favorites!`}),!0}function h(){const e=localStorage.getItem("favorites");return JSON.parse(e)||[]}let w=[];const R=document.querySelector(".favorites-text"),f=document.querySelector(".practice-list"),L=document.querySelector(".js-pagination");function de(e,t){const s=t<768?8:10;let r=[];for(let i=0;i<e.length;i+=s)r.push(e.slice(i,i+s));return r}function ue(e){const t=e.target.closest(".exercise-remove-btn");if(!t)return;const s=t.getAttribute("data-exercise-id");s&&_(s)&&g(h())}function P(e){f.innerHTML=D(e,!0),T()}function G(e,t){L.innerHTML="",L.classList.remove("visually-hidden"),e.forEach((s,r)=>{const i=c({pageId:r,content:r+1,liClassNames:["pagination-item",t===r?"active":""]});i.addEventListener("click",()=>{P(s),G(e,r),f.scrollIntoView({behavior:"smooth"})}),L.appendChild(i)})}function g(e=w){if(e.length)R.classList.add("visually-hidden"),f.classList.remove("hidden");else{R.classList.remove("visually-hidden"),f.classList.add("hidden");return}const t=window.innerWidth;L.classList.add("hidden");let s=t<768?8:10;if(t>=1440&&(s=10),e.length<=s)P(e);else{const r=de(e,t);P(r[0]),G(r,0)}}document.addEventListener("DOMContentLoaded",()=>{if(window.location.pathname.includes("favorites.html")){w=h(),g(w);const e=Y(()=>g(w),50);window.addEventListener("resize",e),f.addEventListener("click",fe),f.addEventListener("click",ue)}});let d=null,u=null;function N(e){pe(e).then(t=>{d=document.querySelector("#add-favorites"),u=document.querySelector("#remove-favorites"),d&&(d.dataset.exercise=JSON.stringify(t),d.addEventListener("click",V,{passive:!0})),u&&(u.dataset.exercise=JSON.stringify(t),u.addEventListener("click",K,{passive:!0})),o.exercisePopUpCloseBtn.addEventListener("click",E,{passive:!0}),o.exercisePopUpBackdrop.addEventListener("click",z,{passive:!0}),o.exercisePopUpBackdrop.classList.add("is-open"),o.body.classList.add("overflow-hidden"),document.addEventListener("keydown",Q)}).catch(t=>{m.error({message:`${t}`})})}function E(){o.exercisePopUpBackdrop.classList.remove("is-open"),o.body.classList.remove("overflow-hidden"),d&&d.removeEventListener("click",V),u&&u.removeEventListener("click",K),o.exercisePopUpBackdrop.removeEventListener("click",z),o.exercisePopUpCloseBtn.removeEventListener("click",E),document.removeEventListener("keydown",Q),d=null,u=null}function pe(e){return new Promise((t,s)=>{X(e).then(r=>{o.exercisePopUpContent.innerHTML=le(r),t(r)}).catch(r=>{s(r)})})}function z(e){e.target===o.exercisePopUpBackdrop&&E()}function me(e){let t=h();t.push(e),localStorage.setItem("favorites",JSON.stringify(t)),window.location.pathname.includes("favorites.html")&&g(t),m.success({message:"Exercise added to favorites!"})}function V(e){const t=JSON.parse(d.dataset.exercise);me(t),e.stopPropagation(),N(t._id)}function K(e){const t=JSON.parse(u.dataset.exercise);_(t._id)&&window.location.pathname.includes("favorites.html")&&g(h()),N(t._id),e.stopPropagation()}function Q(e){e.code==="Escape"&&E()}function ye(e){const t=e.target,s=t.closest("li.pagination-item:not(.active):not(.three-dots)")??t.closest("li.pagination-arrow:not(.disabled)");if(!s)return;const r=Number(s.dataset.id);b.set("page",r),l.set("page",r),o.exerciseHeaderSpan.dataset.exercise?F():J(),o.mainSection.scrollIntoView()}function Ce(e){const s=e.target.closest("li[data-filter]");if(!s)return;document.querySelectorAll(".js-filters .active").forEach(n=>n.classList.remove("active")),s.classList.add("active"),o.searchForm.reset(),o.searchForm.classList.add("hidden");const i=s.dataset.filter,a=Object.keys(C).find(n=>C[n]===i);a&&(b.set("filter",C[a]),b.set("page",1),l.delete("muscles"),l.delete("bodypart"),l.delete("equipment"),l.set("page",1),o.list.classList.replace("exercise-list","filtered-list"),J()),re()}function we(e){const s=e.target.closest("li.category-card");if(!s)return;let r=s.dataset.filter.toString().toLowerCase();r==="body parts"&&(r="bodypart");const i=s.dataset.name;ie(i),l.set(r,i),l.set("page",1),o.list.classList.replace("filtered-list","exercise-list"),o.searchForm.classList.remove("hidden"),o.list.innerHTML="",F(),o.mainSection.scrollIntoView()}function Le(e){e.preventDefault();const t=o.searchInput.value.trim();l.set("keyword",t),F()}function fe(e){const t=e.target.closest(".exercise-start-btn");if(!t)return;const s=t.getAttribute("data-exercise-id");s&&N(s)}export{l as a,J as b,ye as c,we as d,fe as e,he as f,ge as g,F as h,Le as i,Ce as o,b as q,o as r,xe as s};
//# sourceMappingURL=eventHandlers-15ffe98d.js.map
