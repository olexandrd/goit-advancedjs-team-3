import{r as a,c as T,d as F,e as M,q as w,a as o,F as h,f as B,g as N}from"./header-5e6dc6c8.js";import{i as g}from"./vendor-790bbfe5.js";function U(e){const t=e.map(({filter:s,name:i,imgURL:r})=>`<li class="filtered-item" data-filter="${s}" data-name="${i}">
            <img
              src="${r}"
              alt="${i}"
              class="filter-img"
...
//# sourceMappingURL=search-input-12069d1b.js.map
